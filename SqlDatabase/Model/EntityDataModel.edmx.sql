...
-- --------------------------------------------------
-- Date Created: 02/03/2012 16:22:18
...
IF OBJECT_ID(N'[dbo].[FK_UserGroup]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Users] DROP CONSTRAINT [FK_UserGroup];
GO
IF OBJECT_ID(N'[dbo].[FK_CredentailUser_Credentail]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CredentailUser] DROP CONSTRAINT [FK_CredentailUser_Credentail];
GO
IF OBJECT_ID(N'[dbo].[FK_CredentailUser_User]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CredentailUser] DROP CONSTRAINT [FK_CredentailUser_User];
GO
IF OBJECT_ID(N'[dbo].[FK_CredentailGroup_Credentail]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CredentailGroup] DROP CONSTRAINT [FK_CredentailGroup_Credentail];
GO
IF OBJECT_ID(N'[dbo].[FK_CredentailGroup_Group]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CredentailGroup] DROP CONSTRAINT [FK_CredentailGroup_Group];
GO
...
IF OBJECT_ID(N'[dbo].[FK_CommentArticle]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comments] DROP CONSTRAINT [FK_CommentArticle];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_ReportArticle]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Articles] DROP CONSTRAINT [FK_ReportArticle];
GO
IF OBJECT_ID(N'[dbo].[FK_ReportComment]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comments] DROP CONSTRAINT [FK_ReportComment];
GO
IF OBJECT_ID(N'[dbo].[FK_OptionTypeOption]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Options] DROP CONSTRAINT [FK_OptionTypeOption];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Credentails]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Credentails];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CredentailUser]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CredentailUser];
GO
IF OBJECT_ID(N'[dbo].[CredentailGroup]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CredentailGroup];
GO
